...
class Validate
{
    ...
    public static function enumFields()
    {
        return [
            ...
            'currency-types'        =>  [
                'AED', 'ANG', 'ARS', 'AUD', 'AWG', 'AZN', 'BGN', 'BHD', 'BOB', 'BRL', 'BYR', 'CAD', 'CHF', 'CLP',
            ...
            'product-type'          =>  [
                'ACTIVITY', 'DAYTOUR', 'MULTIDAYTOUR', 'ENQUIRY', 'PRIVATE_TOUR', 'TICKET', 'RENTAL',
            ...
            'source'                =>  [
                'ONLINE', 'INTERNAL', 'PARTNERS', 'COMMUNITY', 'MARKETPLACE', 'MARKETPLACE_PREF_RATE',
                'API'
            ],

            'status'                =>  [
                'PROCESSING', 'NEW', 'ON_HOLD', 'PENDING_SUPPLIER', 'PENDING_CUSTOMER', 'CONFIRMED',
                'CANCELLED', 'ABANDONED_CART'
            ],

            'tag-types'             =>  [
                'TYPE', 'CATEGORY', 'INTEREST', 'INTENSITY', 'SKILL_LEVEL', 'AGE', 'ACCESSIBILITY',
                'SUITABILITY'
            ],

            'tag-values'            =>  [
                'TYPE'          => [
                    'ATTRACTION', 'TOUR', 'ACTIVITY', 'RENTAL', 'EVENT', 'LESSON',
                    'TICKET', 'TRANSPORT'
                ],

                'CATEGORY'      => [
                    'ABSEILING', 'ACCOMMODATION PACKAGE', 'ACTIVE_TOURS',
                ...
                'INTEREST'       => [
                    'FAMILY', 'CULTURAL', 'SIGHTSEEING', 'LIFESTYLE', 'LUXURY',
                ...
                'ACCESSIBILITY'  => [
                    'VISION_IMPAIRED', 'HEARING_IMPAIRED', 'PARAPLEGIC',
                    'QUADRIPLEGIC', 'EPILEPTIC', 'ASTHMATIC'
                ],

                'SUITABILITY'    => [
                    'ANY_WEATHER', 'DAY_TIME', 'NIGHT_TIME', 'FAMILY', 'GIFT_VOUCHER',
            ...
            'voucher-value-type'    =>  [
                'VALUE_LIMITPRODUCT', 'VALUE', 'VALUE_LIMITCATALOG', 'PERCENT_LIMITPRODUCT',
