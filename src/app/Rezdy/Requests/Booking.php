...
class Booking extends BaseRequest implements RequestInterface
{
	...
	public function __construct($params = '')
	{
		...
		$this->setClassMap = [
			'CC_RezdyAPI\Rezdy\Requests\Objects\CreatedBy' 				=> 'createdBy',
			'CC_RezdyAPI\Rezdy\Requests\Objects\CreditCard'  			=> 'creditCard',
			'CC_RezdyAPI\Rezdy\Requests\Customer' 						=> 'customer',
			'CC_RezdyAPI\Rezdy\Requests\Objects\BookingResellerUser'	=> 'resellerUser'
		];

		//Sets the class mapping for multiple item sets to the request 				
		$this->addClassMap  = [
			'CC_RezdyAPI\Rezdy\Requests\Objects\Field'			=> 'fields',
			'CC_RezdyAPI\Rezdy\Requests\Objects\BookingItem'	=> 'items',
			'CC_RezdyAPI\Rezdy\Requests\Objects\BookingPayment'	=> 'payments',
			'CC_RezdyAPI\Rezdy\Requests\Objects\Participant'	=> 'participants'
		];
